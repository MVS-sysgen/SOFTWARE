...
# builds the JCL needed to install DFSPC
...
cat V1R0M00.ASM.TAPE/DFSPC.txt
...
cat V1R0M00.ISPF.TAPE/PDFSPC0.txt
echo "./ ADD NAME=HDFSPC0"
cat V1R0M00.ISPF.TAPE/HDFSPC0.txt
echo "@@"

...
//SLIB     DD DSN=SYSGEN.ISPF.SLIB,DISP=(,CATLG),DCB=SYS1.MACLIB,
//         VOL=SER=PUB001,UNIT=SYSDA,SPACE=(CYL,(2,0,20),RLSE)
//SLIB     DD DSN=SYSGEN.ISPF.TLIB,DISP=(,CATLG),DCB=SYS1.MACLIB,
//         VOL=SER=PUB001,UNIT=SYSDA,SPACE=(CYL,(2,0,20),RLSE)
//CLIB     DD DSN=SYSGEN.ISPF.CLIB,DISP=(,CATLG),DCB=SYS1.MACLIB,
//         VOL=SER=PUB001,UNIT=SYSDA,SPACE=(CYL,(2,0,20),RLSE)
//*

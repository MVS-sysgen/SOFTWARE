...
//SYSIN  DD *
 ...
 /***********************************************************/
  ...
  DELETE RPF.##CHANGEME##.SRPFJCL SCRATCH PURGE
  DELETE RPF.##CHANGEME##.SRPFHELP SCRATCH PURGE
  DELETE RPF.##CHANGEME##.SRPFLOAD SCRATCH PURGE
  SET MAXCC=0
  SET LASTCC=0
//* ---- RECEIVE JCL ----
...
//SYSPRINT DD  SYSOUT=*
//HELPIN   DD  DISP=SHR,DSN=RPF.##CHANGEME##.SRPFHELP
...
//LOAD     DD  DISP=SHR,DSN=RPF.##CHANGEME##.SRPFLOAD

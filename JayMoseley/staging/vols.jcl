//VOLS$    JOB (SYS),'INSTALL VOLS',CLASS=S,MSGCLASS=X                  00010000
//*                                                                     00020000
//* ***************************************************************** * 00030000
//* INSTALL VOLS COMMAND IN SYS2.CMDLIB (HELP IN SYS2.HELP)           * 00040000
//* ***************************************************************** * 00050000
//*                                                                     00060000
//VOLS    EXEC ASMHCL,APRM='LIST,NODECK,LOAD,RENT',                     00070000
//             MAC1='SYS1.AMODGEN',LPRM='LIST,MAP,NOCAL,RENT'           00080000

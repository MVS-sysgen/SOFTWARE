//TESTDES JOB  CLASS=C,MSGCLASS=A,MSGLEVEL=(1,1),REGION=7000K
//*
//JOBPROC DD   DSN=K.S.V1R5M0.PROCLIB,DISP=SHR
//*
//TESTDES EXEC  PROC=K2KCOBCL
//COPY.SYSUT1 DD *
       ID DIVISION.
       PROGRAM-ID. TESTDES.
      ...
      * esds direct access: read, write, delete, rewrite, unlock
      * -- sorta - esds does not support delete...

       ENVIRONMENT DIVISION.
       DATA DIVISION.
       WORKING-STORAGE SECTION.
       77  WS-BEGIN   PIC X(23) VALUE 'TESTDES WORKING STORAGE'.
       77  KEY77      PIC S9(8) COMP VALUE +0.
      ...
      *    GO TO DO-IT-AGAIN.
       ...
       SCRIPT-1.
           MOVE 0 TO TEST-NUM.
      * 1--- read record THREE (rba = 240). should succeed
           MOVE 240 TO KEY77.
           ADD 1 TO TEST-NUM. MOVE 1 TO EXPECTING.
           PERFORM READ-1.
      * 2--- delete is not part of the esds paradiem...
           ADD 1 TO TEST-NUM. MOVE 2 TO EXPECTING.
      *    PERFORM DELETE-1.
      * 3--- rewrite record THREE (rba = 240). should fail
           ADD 1 TO TEST-NUM. MOVE 2 TO EXPECTING.
           PERFORM REWRITE-1.
      * 4--- unlock record THREE (rba = 240). should succeed
           ADD 1 TO TEST-NUM. MOVE 1 TO EXPECTING.
           PERFORM UNLOCK-1.
      * 5--- read/update record THREEA (rba = 320). should succeed
           MOVE 320 TO KEY77.
           ADD 1 TO TEST-NUM. MOVE 1 TO EXPECTING.
           PERFORM READ-UPDATE-1.
      * 6--- delete is not part of the esds paradiem...
           ADD 1 TO TEST-NUM. MOVE 1 TO EXPECTING.
      *    PERFORM DELETE-1.
      * 7--- rewrite record THREEA (rba = 320). should succeed
           ADD 1 TO TEST-NUM. MOVE 1 TO EXPECTING.
           PERFORM REWRITE-1.
      * 8--- unlock record THREEA (rba = 320). should succeed
           ADD 1 TO TEST-NUM. MOVE 1 TO EXPECTING.
           PERFORM UNLOCK-1.
      * 9--- read record THREEA (rba = 320). should succeed
           ADD 1 TO TEST-NUM. MOVE 1 TO EXPECTING.
           PERFORM READ-1.
      * 10-- read/update record THREEB (rba = 400). should succeed
           MOVE 400 TO KEY77.
           ADD 1 TO TEST-NUM. MOVE 1 TO EXPECTING.
           PERFORM READ-UPDATE-1.
      * 11-- rewrite record THREEB (rba = 400). should succeed
           ADD 1 TO TEST-NUM. MOVE 1 TO EXPECTING.
           PERFORM REWRITE-1.
      * 12-- unlock record THREEB (rba = 400). should succeed
           ADD 1 TO TEST-NUM. MOVE 1 TO EXPECTING.
           PERFORM UNLOCK-1.
      * 13-- read/update record THREEB (rba = 400). should succeed
           ADD 1 TO TEST-NUM. MOVE 1 TO EXPECTING.
           PERFORM READ-UPDATE-1.
      * 14-- read/update record THREEB (rba = 400). should fail
           ADD 1 TO TEST-NUM. MOVE 2 TO EXPECTING.
           PERFORM READ-UPDATE-1.
      * 15-- rewrite record THREEB (rba = 400). should succeed
           ADD 1 TO TEST-NUM. MOVE 1 TO EXPECTING.
           PERFORM REWRITE-1.
      * 16-- unlock record THREEB (rba = 400). should succeed
           ADD 1 TO TEST-NUM. MOVE 1 TO EXPECTING.
           PERFORM UNLOCK-1.
      * ---- that's all folks...
           GO TO DO-IT-AGAIN.

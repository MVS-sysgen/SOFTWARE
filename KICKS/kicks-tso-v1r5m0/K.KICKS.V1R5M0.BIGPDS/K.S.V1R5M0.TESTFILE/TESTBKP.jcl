//TESTBKP JOB  CLASS=C,MSGCLASS=A,MSGLEVEL=(1,1),REGION=7000K
//*
//JOBPROC DD   DSN=K.S.V1R5M0.PROCLIB,DISP=SHR
//*
//TESTBKP EXEC  PROC=K2KCOBCL
//COPY.SYSUT1 DD *
       ID DIVISION.
       PROGRAM-ID. TESTBKP.
      ...
      * ksds browse, readprev, readnext, read -- VIA PATH

       ENVIRONMENT DIVISION.
       DATA DIVISION.
       WORKING-STORAGE SECTION.
       77  WS-BEGIN   PIC X(23) VALUE 'TESTBKP WORKING STORAGE'.
       ...
       01  PF-MSG.
         02  PF-MSG0  PIC X(79)
           VALUE 'KSDS browse test w/path (use w/CEDF)'.
         02  PF-MSG1.

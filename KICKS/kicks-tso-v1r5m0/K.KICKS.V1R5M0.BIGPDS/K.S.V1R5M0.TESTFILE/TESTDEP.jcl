//TESTDEP JOB  CLASS=C,MSGCLASS=A,MSGLEVEL=(1,1),REGION=7000K
//*
//JOBPROC DD   DSN=K.S.V1R5M0.PROCLIB,DISP=SHR
//*
//TESTDEP EXEC  PROC=K2KCOBCL
//COPY.SYSUT1 DD *
       ID DIVISION.
       PROGRAM-ID. TESTDEP.
      ...
      * -- sorta - esds does not support delete...
       ...
       77  WS-BEGIN   PIC X(23) VALUE 'TESTDEP WORKING STORAGE'.
       ...
       01  PF-MSG.
         02  PF-MSG0  PIC X(79)
           VALUE 'ESDS direct test w/path (use w/CEDF)'.
         02  PF-MSG1.
      ...
      * 5--- read/update record THREEA (key = threea). should succeed
           ...
           ADD 1 TO TEST-NUM. MOVE 1 TO EXPECTING.
           PERFORM READ-UPDATE-1.
      * 6--- delete record THREEA (key = threea). should fail
           ADD 1 TO TEST-NUM. MOVE 2 TO EXPECTING.
      ...
      * 8--- unlock record THREEA (key = threea). should succeed
           ADD 1 TO TEST-NUM. MOVE 1 TO EXPECTING.
           PERFORM UNLOCK-1.
      * 9--- read record THREEA (key = threea). should succeed
           ADD 1 TO TEST-NUM. MOVE 1 TO EXPECTING.
           PERFORM READ-1.
      ...
      * 17-- WRITE record THREEA (key = threea). should fail
           ...
           MOVE 'THREEA' TO KEY77.
           PERFORM WRITE-1.
      * 18-- WRITE record THREEA (key = threea). should fail
           ADD 1 TO TEST-NUM. MOVE 2 TO EXPECTING.
           MOVE SAVREC77 TO REC77.
           PERFORM WRITE-1.
      * 19-- WRITE record THREEA (key = threea). should fail
           ADD 1 TO TEST-NUM. MOVE 2 TO EXPECTING.
           PERFORM WRITE-1.
      * ---- that's all folks...
           GO TO DO-IT-AGAIN.

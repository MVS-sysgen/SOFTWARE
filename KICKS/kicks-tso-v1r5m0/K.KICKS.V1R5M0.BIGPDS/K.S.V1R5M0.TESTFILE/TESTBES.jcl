//TESTBES JOB  CLASS=C,MSGCLASS=A,MSGLEVEL=(1,1),REGION=7000K
//*
//JOBPROC DD   DSN=K.S.V1R5M0.PROCLIB,DISP=SHR
//*
//TESTBES EXEC  PROC=K2KCOBCL
//COPY.SYSUT1 DD *
       ID DIVISION.
       PROGRAM-ID. TESTBES.
      ...
      * esds browse, readprev, readnext, read

       ENVIRONMENT DIVISION.
       DATA DIVISION.
       WORKING-STORAGE SECTION.
       77  WS-BEGIN   PIC X(23) VALUE 'TESTBES WORKING STORAGE'.
       ...
       01  PF-MSG.
         02  PF-MSG0  PIC X(79) VALUE 'ESDS browse test (use w/KEDF)'.
         02  PF-MSG1.

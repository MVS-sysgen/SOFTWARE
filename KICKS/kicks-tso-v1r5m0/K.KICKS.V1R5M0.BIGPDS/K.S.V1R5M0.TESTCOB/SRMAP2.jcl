//SRMAP2  JOB  CLASS=C,MSGCLASS=A,MSGLEVEL=(1,1),REGION=2000K
//*
//JOBPROC DD   DSN=K.S.V1R5M0.PROCLIB,DISP=SHR
//*
//TESTMSD EXEC KIKMAPS,MAPNAME=TESTMSD PARM.ASM='DECK,LIST'
//COPY.SYSUT1 DD *
...
ALPHA24  KIKMDF POS=(15,45),LENGTH=6,ATTRB=(FSET)
         KIKMDF POS=(17,01),LENGTH=7,OCCURS=20,INITIAL='_-_-_-_'
TABLE24  KIKMDF POS=(20,01),LENGTH=7,OCCURS=20,INITIAL='_______',      *
               ATTRB=(NUM,FSET)
...
ALPHA43  KIKMDF POS=(27,45),LENGTH=6,ATTRB=(FSET)
         KIKMDF POS=(29,01),LENGTH=7,OCCURS=20,INITIAL='_-_-_-_'
TABLE43  KIKMDF POS=(32,01),LENGTH=7,OCCURS=20,INITIAL='_______'
...
//COPY.SYSUT1 DD *
      ...
      * END-EXEC.
      *
      * SRMAP2 IS 'PRO' ONLY EXAMPLE TESTING USE OF
      * 'OCCURS' IN A BMS MAP
...
<REM>AAA<ENTER>
AAA<TAB>
<REM> note the following not justified due to
<REM>      field(s) being initially '_' filled...
111<TAB>
<TAB>
222222222<enter>
/*
